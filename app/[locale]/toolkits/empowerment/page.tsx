    ...
    <main>
            ...
            <div className="two-columns" style={{ display: 'flex', gap: '50px', alignItems: 'flex-start', marginTop: '40px' }}>
              ...
              <div className="column" style={{ flex: 1 }}>
                <div className="image-container" style={{ borderRadius: '10px', overflow: 'hidden', boxShadow: '0 5px 15px rgba(0,0,0,0.1)' }}>
                  <img src="/images/empowerment-importance.jpg" alt="Empowerment and confidence" style={{ width: '100%', display: 'block' }} />
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="toolbox" id="tools" style={{ padding: '50px 0 100px 0', background: 'var(--soft-gradient)' }}>
        <div className="container">
          ...
          {/* Coming Soon Section */}
          <div style={{ textAlign: 'center', margin: '50px auto 30px', maxWidth: '600px' }}>
            <div style={{ background: 'white', padding: '40px', borderRadius: '20px', boxShadow: '0 10px 40px rgba(0,0,0,0.1)', border: '2px solid var(--primary-color)' }}>
              <h3 style={{ marginBottom: '20px', color: 'var(--primary-color)' }}>{t('comingSoon.title')}</h3>
              <p style={{ marginBottom: '20px', color: 'var(--slate-blue)' }}>{t('comingSoon.description')}</p>
              <Link href="/#contact" className="btn" style={{ fontSize: '1.2rem', padding: '15px 40px', width: '100%' }}>{t('comingSoon.btn')}</Link>
            </div>
          </div>
        </div>
      </section>
