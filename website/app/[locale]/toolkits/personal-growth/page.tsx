      ...
      <section className="toolbox" id="tools" style={{ padding: '50px 0 100px 0', background: 'var(--soft-gradient)' }}>
        <div className="container">
          ...
          <div style={{ textAlign: 'center', margin: '50px auto 30px', maxWidth: '350px' }}>
             <a href="https://buy.stripe.com/4gM6oHdmE46w2yofQPe3e01" className="btn" target="_blank" rel="noopener noreferrer" style={{ display: 'block', width: '100%', padding: '15px 20px', textDecoration: 'none' }}>
              {t('buy.btn')}
            </a>
